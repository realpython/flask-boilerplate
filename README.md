...
1. Using Heroku? Make sure you deactivate your virtualenv once done deplying:

Deactivate virtualenv: `deactivate`
Reactivate virtualenv: (1) Unix - `source venv/bin/activate` (2) Windows - `venv\scripts\activate`
